...
Config.Items = {
    {Label = 'Gold', Name = 'gold_0'},
    {Label = 'Designer Clothes', Name = 'clothe', Amount = 2},
  --  {Label = 'Knuckle Dusters ', Name = 'WEAPON_KNUCKLE'}, cant use weapons only items 
	{Label = 'Bag of Weed ', Name = 'marijuana'},
	{Label = 'Bag of Coke ', Name = 'coke'},
    {Label = 'Touch Screen Radio', Name = 'highradio'},
	{Label = 'Diamond ring', Name = 'ring'},
	{Label = 'iPhone x', Name = 'iphone'},
	{Label = 'Laptop', Name = 'laptop'},
	{Label = 'Spice', Name = 'spice'},
	{Label = 'Keycard', Name = 'keycard', Amount = 1},
} 
