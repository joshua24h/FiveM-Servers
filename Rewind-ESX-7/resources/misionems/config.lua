...
Config.LimitToAmbulanceJob = true

Config.ActivationKey = 163 --206
Config.ActivationKeyText = 'INPUT_SELECT_WEAPON_SNIPER'
...
Config.Formulas = {
    moneyPerLevel               = function(level)                   return 25 * level * level end,
...
Config.Hospitals = {
    ...
    },
    {
        ...
        spawnPoints = {
            ...
            {x = -257.266, y = -1566.302, z = 31.148},  {x = -226.221, y = -1298.315, z = 30.606},
