...
Citizen.CreateThread(function()
	...
	if Config.EnableSantaPodPed then
		for _, item in pairs(Config.LocationPod) do
	        ...
	        Citizen.Wait(200)	
			TaskPlayAnim(npc,"random@street_race","grid_girl_race_start",1.0, 1.0, -1, 9, 1.0, 0, 0, 0)
