TokoVoipConfig = {
	...
	plugin_data = {
		...
		TSChannel = "bigdave",
		TSPassword = "davey", -- TeamSpeak channel password (can be empty)
		...
		TSChannelWait = "Waiting For In-Game",

		-- Blocking screen informations
		TSServer = "Join TS Server 31.186.250.99:6740", -- TeamSpeak server address to be displayed on blocking screen
		TSChannelSupport = "Join Public Room 3 for help", -- TeamSpeak support channel name displayed on blocking screen
		TSDownload = "https://www.teamspeak.com/en/downloads/", -- Download link displayed on blocking screen
