...
AddEventHandler('esx_vagosjob:hasEnteredMarker', function(station, part, partNum)
  ...
  if part == 'HelicopterSpawner' then
    ...
    local helicopters = Config.VagosStations[station].Helicopters
...
AddEventHandler('esx_vagosjob:hasEnteredEntityZone', function(entity)
  ...
  if PlayerData.job ~= nil and PlayerData.job.name == 'vagos' and not IsPedInAnyVehicle(playerPed, false) then
