Config = {}
	...
	Config.FishPrice = {a = 5, b = 200} --Will get clean money THIS PRICE IS FOR EVERY 5 FISH ITEMS (5 kg)
	Config.TurtlePrice = {a = 10, b = 300} --Will get dirty money
	Config.SharkPrice = {a = 40, b = 400} --Will get dirty money
