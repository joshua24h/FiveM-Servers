...
AddEventHandler('esx_ballasjob:hasEnteredMarker', function(station, part, partNum)
  ...
  if part == 'HelicopterSpawner' then
    ...
    local helicopters = Config.BallasStations[station].Helicopters
...
AddEventHandler('esx_ballasjob:hasEnteredEntityZone', function(entity)
  ...
  if PlayerData.job ~= nil and PlayerData.job.name == 'ballas' and not IsPedInAnyVehicle(playerPed, false) then
