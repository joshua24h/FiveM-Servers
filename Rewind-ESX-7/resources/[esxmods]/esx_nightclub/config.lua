...
-------- SHOPS --------
    ...
    Flacons = {
        ...
        Type  = 23,
        Items = {
            { name = 'jager',      label = _U('jager'),   price = 32 },
            { name = 'vodka',      label = _U('vodka'),   price = 43 },
            { name = 'rhum',       label = _U('rhum'),    price = 24 },
            { name = 'whisky',     label = _U('whisky'),  price = 75 },
            { name = 'tequila',    label = _U('tequila'), price = 26 },
            { name = 'martini',    label = _U('martini'), price = 57 }
        },
    },
    ...
    NoAlcool = {
        ...
        Type  = 23,
        Items = {
            { name = 'soda',        label = _U('soda'),     price = 45 },
            { name = 'jusfruit',    label = _U('jusfruit'), price = 36 },
            { name = 'icetea',      label = _U('icetea'),   price = 44 },
            { name = 'energy',      label = _U('energy'),   price = 74 },
            { name = 'drpepper',    label = _U('drpepper'), price = 25 },
            { name = 'limonade',    label = _U('limonade'), price = 16 }
        },
    },
    ...
    Ice = {
        ...
        Type  = 23,
        Items = {
            { name = 'ice',     label = _U('ice'),      price = 11 },
            { name = 'menthe',  label = _U('menthe'),   price = 21 }
        },
    },
