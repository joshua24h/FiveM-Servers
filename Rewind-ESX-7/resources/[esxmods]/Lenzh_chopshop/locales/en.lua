Locales['en'] = {
  ['press_to_chop'] = "Press ~INPUT_CONTEXT~ to Get to Work",
  ['map_blip'] = "Chop Shop",
  ['map_blip_shop'] = "Car Transplants",
  ...
  ['shop_prompt'] = 'press ~INPUT_CONTEXT~ to browse Car Transplants.',
  ['item'] = '$%s',
  ['shop_title'] = 'Car Transplants',
