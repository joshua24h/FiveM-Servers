...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Apr 18, 2020 at 11:56 AM
...
CREATE TABLE IF NOT EXISTS `ranks` (
  ...
  `xp` int(11) NOT NULL COMMENT 'The required XP for this rank',
...
CREATE TABLE IF NOT EXISTS `settings` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `userID` int(11) NOT NULL,
  `keybindings` text COLLATE utf8_bin,
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `callsign` varchar(75) COLLATE utf8_bin DEFAULT '',
